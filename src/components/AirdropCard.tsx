...
const AirdropCard = () => {
  ...
  // const address = "0xbEA18A39a1cEe253705eB5e966fe23F26dD109eF";
    ...
    <div className="bg-white dark:bg-[#212429] shadow-[#00000003_0_0_1px,#0000000a_0_4px_8px,#0000000a_0_16px_24px,#00000003_0_24px_32px] rounded-[30px] p-4 w-11/12 max-w-[420px] min-w-[320px] relative">
      ...
      {airdropped && (
        <AirdropInfo
          ...
          value={airdropped ? (airdrop as any)?.[2] : 0n}
          symbol="MOOND"
          icon={
            <>
              <Image
      ...
      <button
        ...
        onClick={onAirdrop}
        disabled={
          loading || left === 0 || airdropped || (airdrop as any)?.[2] === 0n
        }
      >
